...
<template>
  <header class="sticky top-0 z-40 flex h-16 items-center justify-between border-b bg-white px-6 border-slate-200 shadow-2xs">
    ...
    <div class="flex items-center gap-2">
      ...
      <!-- 🛡️ Sabit %5 Escrow Komisyon Rozeti & Kolay Erişim Linki -->
      <NuxtLink
        ...
        title="Sektör ayrımı yapmaksızın tüm işlemlerde sabit %5 Escrow komisyonu"
      >
        <ShieldCheck :size="14" class="text-emerald-600" />
        <span>Escrow Komisyonu: <strong class="text-emerald-700 font-mono font-black">%5 Sabit</strong></span>
      </NuxtLink>
