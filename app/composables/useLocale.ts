...
export const translations: Record<Locale, Record<string, string>> = {
  tr: {
    ...
    pricing_disclaimer: 'Bu hizmet Özgürsoft Bilişim A.Ş. tarafından sunulmaktadır. Şirketimizin Kamu İhale Kurumu (EKAP) veya başka bir kamu kurumu ile herhangi bir bağlantısı bulunmamaktadır.',
    ...
    feat_kik_decisions: 'K Kik Kararları',
  ...
  en: {
    ...
    pricing_disclaimer: 'This service is provided by Ozgursoft Bilisim A.S. Our company is not affiliated with the Public Procurement Authority (EKAP) or any other government institution.',
    ...
    feat_kik_decisions: 'K Kik Decisions',
