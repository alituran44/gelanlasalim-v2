  ...
  if (typeof window !== 'undefined' && !isInitialized) {
    ...
    if (saved) {
      try {
        ...
        // If saved data contains legacy mock tenders or outdated schema, purge and overwrite with pure Turkish default
        if (
          str.includes('how does') || 
          str.includes('private sector') || 
          ...
          str.includes('balıkesir kurumsal') ||
          str.includes('bursa kurumsal')
        ) {
