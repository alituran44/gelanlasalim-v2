...
const faqs = [
  ...
  { q: "Ödeme altyapınız güvenli mi? Hangi yöntemler destekleniyor?", a: "Ödemeleriniz TCMB ve BDDK lisanslı ödeme kuruluşu (Paynkolay - Aktif Bank) güvencesiyle 256-Bit SSL şifrelemeli 3D Secure protokolü üzerinden gerçekleşir. Troy, Visa, MasterCard, American Express ve kurumsal banka havalesi desteklenmektedir. Kart bilgileriniz asla sunucularımızda saklanmaz." },
